...
const sections = [
  ...
  },
  {
    ...
    content: [
      ...
      "• Wallet address for blockchain features",
  ...
  },
  {
    ...
    content: [
      ...
      "• Refunds processed within 5-10 business days of receiving returned item",
      "• Shipping costs for returns are your responsibility unless product is defective",
      "",
      "**Warranty:**",
